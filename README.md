...
Este projeto é apenas uma base inicial e será evoluído com novas
funcionalidades.
...
Ferramentas: - FFmpeg (obrigatório para MP3)

------------------------------------------------------------------------

## ⚙️ Pré-requisitos

Node.js, Python e FFmpeg instalados.
...
cd server pip install flask flask-cors yt-dlp python server.py
